...
MODEM_CHAT_SCRIPT_CMDS_DEFINE(nordic_nrf91_slm_shutdown_script_cmds,
			      MODEM_CHAT_SCRIPT_CMD_RESP("AT+CFUN=0", ok_match));

MODEM_CHAT_SCRIPT_DEFINE(nordic_nrf91_slm_shutdown_script, nordic_nrf91_slm_shutdown_script_cmds,
			 abort_matches, modem_cellular_chat_callback_handler, 10);
...
#define MODEM_CELLULAR_DEVICE_NORDIC_NRF91_SLM(inst)						   \
	...
	MODEM_CELLULAR_DEFINE_INSTANCE(inst, 100, 100, 2000, 10000, false,                         \
				       ...
				       &nordic_nrf91_slm_shutdown_script)
